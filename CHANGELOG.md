...
- The capture and ask drawers open only when the pointer reaches their grip. A band along the whole edge opened them whenever the reader reached for a tag, the view switch or the legend.
