...
const STRINGS = {
  ...
  "zh-Hant": {
    ...
    "app.deleteNotebookAsk": "要刪除「{name}」嗎？裡面的來源和對話會一起刪除，收納袋裡的東西會留著。",
    "app.generating": "這本筆記本有工作正在執行",
    "time.justNow": "剛剛",
    "time.minutes": "{n} 分鐘前",
    "time.hours": "{n} 小時前",
    "time.days": "{n} 天前",
    ...
    "cite.reasonNoSource": "這本筆記本裡沒有來源 {id}，可能已經移除。",
    ...
    "inbox.pending": "{n} 則等待中",
    "inbox.loading": "載入中…",
    "inbox.loadFailed": "{message}",
    "inbox.openFailed": "{message}",
    "inbox.fileInto": "歸檔到某本筆記本",
    "inbox.fileIntoPlaceholder": "歸檔到…",
    "inbox.newNotebook": "新的筆記本…",
    "inbox.filedIn": "已在 {where}",
    "inbox.firstRun.keep": "貼進來的東西會照原樣保存，並在背景讀取。",
    "inbox.firstRun.facets": "筆記本是之後歸檔用的。等你知道某樣東西要做什麼用，再把它放進去。",
    "inbox.firstRun.cost": "摘要要另外按才會執行。只是收著，不花錢。",
    "inbox.find": "找找你留下的東西…",
    "inbox.findClear": "清除",
    "inbox.noMatch": "沒有符合「{q}」的東西。",
    "inbox.retry": "再試一次",
    "inbox.forget": "移除",
    "inbox.forgetConfirm": "要移除這一則嗎？已經歸檔進筆記本的內容會留著。",
    "inbox.forgetFailed": "無法移除：{message}",
