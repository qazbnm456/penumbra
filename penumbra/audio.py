"""`GeneratePodcastScript` — the RLM task behind the Audio Overview (`penumbra audio`).

Same citation-grounded `RLMTask` pattern as `AnswerQuestion`/the Orbit Guide tasks: two input
...
sources in this collection — the kind of natural, conversational back-and-forth two people have when
