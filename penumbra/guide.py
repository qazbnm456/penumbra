"""Orbit Guide: whole-corpus artifacts generated from an orbit's sources — a summary, an FAQ,
...
class GenerateSummary(GroundedTask):
    ...
    instructions = _grounded_instructions(
        "You are writing a concise summary of the sources in this collection — the key points a "
