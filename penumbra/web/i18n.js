...
const STRINGS = {
  ...
  "zh-Hant": {
    ...
    "err.runTimedOut": "這次執行超過時間上限而被中止。較長的 Podcast 需要更多時間：把 PN_RUN_TIMEOUT_SECONDS 調高後再試一次。",
    ...
    "horizon.empty": "這裡還沒有東西。在上面貼一個連結，它就會留在這裡。",
    "horizon.stop": "停止",
    "horizon.more": "更早的",
    ...
    "askH.hintOrbit": "按 Enter 直接在這個軌道的對話裡提問，會跑一次模型。",
    "mode.label": "檢視方式",
    "mode.map": "星圖",
    "mode.list": "清單",
    "mode.graph": "知識圖",
    ...
    "map.noEntities": "還沒有實體：這裡的東西都還沒摘要。",
    "map.enter": "進入軌道",
    "map.distil": "摘要 {n} 項",
