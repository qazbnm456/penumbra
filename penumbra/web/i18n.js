...
const STRINGS = {
  ...
  "zh-Hant": {
    ...
    "settings.filing": "新收的東西怎麼歸入軌道",
    "settings.filingManual": "人工",
    ...
    "map.todoNone": "都整理好了",
    "map.todoTitle": "等你處理的",
    "map.todoLoose": "還沒歸入軌道",
    "map.todoSuggest": "建議歸入",
    "map.todoSummarise": "還沒摘要",
    "map.todoMore": "還有 {n} 則",
    "suggest.autoFiled": "已自動歸入「{orbit}」：{title}",
    "suggest.autoFiledMany": "已自動歸入 {n} 則",
    "suggest.autoUndo": "移出",
    "suggest.autoUndone": "已移回視界：{title}",
    "suggest.autoUndoFailed": "移不出來：{message}",
    "horizon.filedHere": "在「{name}」",
    "horizon.moveTo": "移到「{name}」",
    "horizon.moveLabel": "目前在「{name}」，選一個軌道把它移過去",
    "horizon.alsoFile": "也歸入…",
    ...
    "map.enter": "進入軌道",
    "map.study": "進去研讀",
    "map.studyTip": "打開這個軌道和 AI 一起讀：它會讀完這裡的所有來源，回答時附上引用。",
    "lens.study": "進去研讀「{name}」",
    "chat.keepAsMoon": "收成衛星",
    "chat.keepAsMoonHelp": "把這則回答變成這個軌道的來源，也就是星圖上的一顆衛星。之後的提問就能引用它。",
    "chat.keepNoNote": "存好之後找不到這則筆記",
    "chat.kept": "已收成這個軌道的衛星",
    "chat.keptNotice": "收成衛星了，之後的提問可以引用它。",
    "err.keepAsMoon": "收不進來：{message}",
    "map.distil": "摘要 {n} 項",
