...
This keeps `Utterance.speaker` a closed `Literal[...]` that citations and voice mapping can rely on, and keeps `PN_TTS_VOICE_HOST_A` and `PN_TTS_VOICE_HOST_B` a fixed pair of settings. It is a deliberate scope cut.
