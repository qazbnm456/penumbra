...
A user with a Chinese interface got an English orbit title, because the one place they had actually said which language they read was invisible to `naming.SuggestLanguage`.
