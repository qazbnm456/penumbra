...
own machine, and an arbitrary-file-read vulnerability the moment the same function is reachable
over an HTTP endpoint with no per-user authorization behind it (invariants 25 and 77). The full attack was reproduced end
